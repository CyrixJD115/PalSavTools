...
PROJECT = os.path.join(BUILD_DIR, "PST.Bootstrapper/PST.Bootstrapper.csproj")
DIST_DIR = os.path.join(BUILD_DIR, "dist")
PAYLOAD_DIR = os.path.join(BUILD_DIR, "PST.Bootstrapper/payload")
...
PAYLOAD_EXCLUDES = {
    ...
    "PST_standalone", "dist", "build", "Backups", "Logs", "saves",
}
...
def publish(key: str) -> dict | None:
    ...
    marker_path = os.path.join(BUILD_DIR, "PST.Bootstrapper", "portable.marker")
    if portable:
...
"""
    ...
    icon_src = os.path.join(BUILD_DIR, "PST.Bootstrapper", "assets", "icon.png")
...
def _build_nsis(publish_dir: str, name: str) -> dict | None:
    ...
    nsi_script = os.path.join(BUILD_DIR, "installer.nsi")
