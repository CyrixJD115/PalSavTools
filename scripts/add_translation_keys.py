...
NEW_TRANSLATIONS = {'inventory.add_all_effigies': 'Add All Effigies', 'inventory.add_all_effigies_confirm.title': 'Add All Effigies', 'inventory.add_all_effigies_confirm.msg': 'Add all 12 effigy types to key items?', 'inventory.add_all_effigies_done': 'Added effigies to key items.', 'player_item.no_effigies_found': 'No effigies found.', 'inventory.add_all_effigies_qty.title': 'Add All Effigies', 'inventory.add_all_effigies_qty.prompt': 'How many of each effigy type?', 'player_item.add_all_effigies_qty.title': 'Add All Effigies', 'player_item.add_all_effigies_qty.prompt': 'How many of each effigy type?'}
OLD_KEYS = ['inventory.max_all_abilities', 'inventory.max_all_abilities_confirm.title', 'inventory.max_all_abilities_confirm.msg', 'inventory.max_all_abilities_done', 'inventory.max_all_abilities_done.title', 'inventory.max_all_abilities_done.bulk']
