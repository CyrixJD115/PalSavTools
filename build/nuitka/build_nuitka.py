...
_INCLUDE_MODULES = [
    ...
    'palsav.rawdata',
    'palooz', 'coord',
    'toolsets', 'toolsets.game_pass_save_fix',
    'toolsets.convertids', 'toolsets.restore_map',
    'toolsets.slot_injector', 'toolsets.character_transfer',
    'toolsets.modify_save', 'toolsets.fix_host_save',
    'toolsets.convert_generic', 'toolsets.xgp_save_extract',
    'xgp_import', 'nerdfont', 'orjson', 'brotli',
