...
modules_to_test = [
    ...
    ('coord', ['sav_to_map']),
    ('xgp_import.container_types', ['ContainerIndex', 'Container', 'FILETIME', 'ContainerFileList']),
    ('xgp_import.gamepass_manager', ['find_container_paths', 'read_container_index', 'convert_to_steam']),
