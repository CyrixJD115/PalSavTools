...
_PYSIDE6_EXCLUDES = [
    ...
    'PySide6.QtLottie',
    'PySide6.QtLottieVectorImageGenerator',
    'PySide6.QtQmlCore',
...
_BUILD_PACKAGES = ['subprocess', 'pathlib', 'shutil', 'cityhash', 'json', 'uuid',
    'time', 'datetime', 'struct', 'enum', 'collections', 'itertools', 'math',
    'zlib', 'gzip', 'zipfile', 'threading', 'multiprocessing', 'io', 'base64',
    'binascii', 'hashlib', 'hmac', 'secrets', 'ssl', 'socket', 'urllib', 'http',
    'mimetypes', 'tempfile', 'glob', 'fnmatch', 'argparse', 'configparser',
