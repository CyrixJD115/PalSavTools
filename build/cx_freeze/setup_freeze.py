...
build_exe_options = {'packages': _BUILD_PACKAGES, 'excludes': _BUILD_EXCLUDES, 'include_files': [('README.md', 'README.md'), ('license', 'license'), ('resources/', 'resources/'), ('src/data/', 'src/data/')], 'zip_include_packages': [], 'zip_exclude_packages': ['*'], 'build_exe': 'PST_standalone', 'optimize': 0}
